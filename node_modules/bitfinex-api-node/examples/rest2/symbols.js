...
rest.symbols().then(symbols => {
  //symbols.map(s => `t${s.toUpperCase()}`)
  symbols[0].forEach(symbol => {
    let str = `t${symbol.toUpperCase()}`;
    symbol_array.push(str)
    //console.log(str)
  })
